...
import { ConfirmSignOutModal } from "@/components/navbar/ConfirmSignOutModal";
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-[color:var(--color-background)]">
